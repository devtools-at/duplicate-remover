...
<p align="center">
  <a href="https://devtools.at/tools/duplicate-remover"><img src="https://img.shields.io/badge/Try%20Online-DevTools.at-blue?style=for-the-badge" alt="Try Online"></a>
...
<p align="center">
  <b>Remove duplicate lines from text</b>
</p>

<p align="center">
  <a href="https://devtools.at/tools/duplicate-remover">Try Online</a> •
...
**[Try Duplicate Remover online at DevTools.at →](https://devtools.at/tools/duplicate-remover)**
...
Remove duplicate lines from text. This is a standalone TypeScript/JavaScript implementation that you can use in your own projects.
...
```typescript
import { process } from '@devtools-at/duplicate-remover';
